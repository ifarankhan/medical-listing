        ...
        @foreach($reviews as $review)
            ...
            <div class="single_review">
                <div class="single_review_img">
                    <img
                        src="{{ asset(
                        !$isAnonymous && $customer->profile_picture
                            ? 'storage/profile_pictures/' . $customer->profile_picture
                            : 'frontend/images/comment_3.png'
                        ) }}"
                        alt="img" width="60" height="60" class="img-fluid w-100">
                </div>
                <div class="single_review_text">
                    <h3>{{ $isAnonymous ? 'Anonymous' : $customer->name }}
